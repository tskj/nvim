...
mason_lspconfig.setup({handlers = {lsp_zero.default_setup, fennel_language_server = _2_}, ensure_installed = {"tsserver", "rust_analyzer", "bashls", "clangd", "omnisharp", "clojure_lsp", "dockerls", "eslint", "elmls", "fsautocomplete", "fennel_language_server", "gopls", "graphql", "html", "htmx", "biome", "lua_ls", "autotools_ls", "marksman", "glsl_analyzer", "powershell_es", "jedi_language_server", "ruff_lsp", "sqlls", "volar", "wgsl_analyzer", "yamlls", "zls"}})
