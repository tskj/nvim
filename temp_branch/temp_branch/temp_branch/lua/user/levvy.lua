...
local function _1_()
  ...
  return print("\nresult took:", ((end_time - start_time) / 1000000), "ms", " and first match is ", matches[1], " and second match is ", matches[2], " and third match is ", matches[3], " and fourth?? match is ", matches[4], " out of the ", #matches, " matches", " with success? ", success)
end
return _1_
