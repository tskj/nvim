...
-- (web filetypes deliberately absent: no auto-formatting there,
-- see plugin/configs/auto-formatting.lua)
...
-- arduino_language_server, azure_pipelines_ls, elixirls, julials,
-- jqls, kotlin_language_server, rnix (or nil_ls, for Nix), ocamllsp
