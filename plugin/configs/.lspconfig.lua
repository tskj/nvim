...
mason_lspconfig.setup({handlers = {lsp_zero.default_setup, fennel_language_server = _2_}, ensure_installed = {"ts_ls", "rust_analyzer", "bashls", "clangd", "clojure_lsp", "dockerls", "eslint", "elmls", "millet", "fsautocomplete", "fennel_language_server", "gopls", "html", "biome", "lua_ls", "autotools_ls", "marksman", "glsl_analyzer", "powershell_es", "jedi_language_server", "sqlls", "vue_ls", "wgsl_analyzer", "yamlls", "zls"}})
